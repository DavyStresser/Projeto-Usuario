...
public partial class TbFatAtdIndProcedimentos
{
    public long CoSeqFatAtendIndProced { get; set; }
    ...
    public long? CoDimProcedimentoAvaliado { get; set; }

    public long? CoDimProcedimentoSolicitado { get; set; }
    ...
    public virtual TbDimProcedimento? CoDimProcedimentoAvaliadoNavigation { get; set; }

    public virtual TbDimProcedimento? CoDimProcedimentoSolicitadoNavigation { get; set; }
